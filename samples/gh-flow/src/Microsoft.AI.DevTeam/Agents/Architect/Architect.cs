...
public class Architect(
    [PersistentState("state", "messages")] IPersistentState<AgentState<ArchitectState>> state,
    ISemanticTextMemory memory,
    Kernel kernel) : AiAgent<ArchitectState>(state, memory, kernel)
{
    public override Task HandleEvent(Event item) => Task.CompletedTask;
}
